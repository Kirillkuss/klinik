...
public class CardPatientServiceTest {
    ...
    public void testFindByNPS( String parametr ) throws Exception{
        Mockito.when( cardPatientRepository.findByNPS( parametr )).thenReturn( Optional.of( cardPatient ));
    ...
    public void testFindByNPSError( String parametr ) throws Exception{
        Mockito.when( cardPatientRepository.findByNPS( parametr )).thenReturn( Optional.empty());
        NoSuchElementException exception = assertThrows(NoSuchElementException.class,
